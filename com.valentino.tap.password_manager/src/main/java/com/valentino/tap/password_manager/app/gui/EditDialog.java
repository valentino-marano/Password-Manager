...
public class EditDialog extends Dialog {
	...
	private void createGUI() {
		...
		Text websiteField = new Text(shell, SWT.SINGLE | SWT.BORDER);
		...
		Text userField = new Text(shell, SWT.SINGLE | SWT.BORDER);
		...
		Text passwordField = new Text(shell, SWT.SINGLE | SWT.BORDER);
		...
		if (password == null) {
			...
			okButton.addSelectionListener(new SelectionAdapter() {
				...
				public void widgetSelected(SelectionEvent e) {
					...
					password.setPassword(passwordField.getText());
